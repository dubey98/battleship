...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"game\", function() { return game; });\n/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./render */ \"./src/render.js\");\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index */ \"./src/index.js\");\n\n\n\nconst game = (() => {\n\tfunction attackPlayer() {\n\t\tlet row = Math.floor(Math.random() * 9);\n\t\tlet col = Math.floor(Math.random() * 9);\n\t\tif (_index__WEBPACK_IMPORTED_MODULE_1__[\"player\"].battleField.isValidAttack(row, col)) {\n\t\t\tconst result = _index__WEBPACK_IMPORTED_MODULE_1__[\"player\"].battleField.receiveAttack(row, col);\n\t\t\t_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"].updatePlayerField(_index__WEBPACK_IMPORTED_MODULE_1__[\"player\"].battleField.board);\n\t\t\tif (_index__WEBPACK_IMPORTED_MODULE_1__[\"player\"].battleField.allShipSunk()) {\n\t\t\t\t_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"].declareWinner(_index__WEBPACK_IMPORTED_MODULE_1__[\"computer\"]);\n\t\t\t}\n\t\t\tif (result) {\n\t\t\t\t_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"].showComputersTurn();\n\t\t\t\tsetTimeout(() => attackPlayer(), 500);\n\t\t\t} else {\n\t\t\t\t_index__WEBPACK_IMPORTED_MODULE_1__[\"player\"].turn = true;\n\t\t\t\t_index__WEBPACK_IMPORTED_MODULE_1__[\"computer\"].turn = false;\n\t\t\t\t_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"].showPlayersTurn();\n\t\t\t\treturn;\n\t\t\t}\n\t\t} else {\n\t\t\tattackPlayer();\n\t\t}\n\t}\n\tfunction attackComputer({ row, col }) {\n\t\tif (!_index__WEBPACK_IMPORTED_MODULE_1__[\"player\"].turn) {\n\t\t\tconsole.log(\"wrong turn\");\n\t\t\treturn;\n\t\t} else if (_index__WEBPACK_IMPORTED_MODULE_1__[\"computer\"].battleField.isValidAttack(row, col)) {\n\t\t\tconsole.log(\"attacking\");\n\t\t\tconst result = _index__WEBPACK_IMPORTED_MODULE_1__[\"computer\"].battleField.receiveAttack(row, col);\n\t\t\tif (_index__WEBPACK_IMPORTED_MODULE_1__[\"computer\"].battleField.allShipSunk()) {\n\t\t\t\t_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"].declareWinner(_index__WEBPACK_IMPORTED_MODULE_1__[\"player\"]);\n\t\t\t}\n\t\t\t_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"].updateComputerField(_index__WEBPACK_IMPORTED_MODULE_1__[\"computer\"].battleField.board);\n\t\t\tif (!result) {\n\t\t\t\t_render__WEBPACK_IMPORTED_MODULE_0__[\"render\"].showComputersTurn();\n\t\t\t\t_index__WEBPACK_IMPORTED_MODULE_1__[\"player\"].turn = false;\n\t\t\t\t_index__WEBPACK_IMPORTED_MODULE_1__[\"computer\"].turn = true;\n\t\t\t\tsetTimeout(() => attackPlayer(), 500);\n\t\t\t}\n\t\t} else {\n\t\t\tconsole.error(\"wrong spot \");\n\t\t\treturn;\n\t\t}\n\t}\n\n\treturn {\n\t\tattackPlayer,\n\t\tattackComputer,\n\t};\n})();\n\n\n//# sourceURL=webpack:///./src/game.js?");
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: player, computer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
